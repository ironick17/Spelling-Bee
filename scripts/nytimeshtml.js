// Copy of NY Times HTML text. I initialize it in a separate <script> to keep it from messing up searching in vscode.
...
<head>
    ...
    <meta name="version" content="v6.7.0" />
    <meta name="CG" content="Crosswords/Games" />
    <meta name="PT" content="spelling bee" />
    <link rel="manifest" href="/games-assets/v2/metadata/sb-web-manifest.json?v=v6.7.0" />
    <link rel="apple-touch-icon" sizes="180x180" href="/games-assets/v2/metadata/sb-apple-touch-icon.png?v=v6.7.0" />
    <link rel="mask-icon" color="#f7cc32" href="/games-assets/v2/metadata/sb-safari-pinned-tab.svg?v=v6.7.0" />
    <link rel="shortcut icon" href="/games-assets/v2/metadata/sb-favicon.ico?v=v6.7.0" />
    ...
    <style id="responsive.css">
        ...
        @media (min-width: 444px) and (max-width: 767.98px) {
            #width-hook {
                width: 1px
            }
        }
    ...
    <link rel="stylesheet" type="text/css" href="/games-assets/v2/foundation.e55bac769cc0add74d1e9fc94c032e6c.css" />
    <link rel="stylesheet" type="text/css"
        href="/games-assets/v2/foundation-game.0f7aa812c9a9a79154c8592cf189905e.css" />
...
<body class="pz-page pz-desktop pz-use-intercept">
    <header class="pz-header pz-game-header">
        <div class="pz-nav" id="js-global-nav">
            <div class="pz-nav__hamburger-helper pz-nav__hamburger pz-nav__hamburger-squeeze" id="js-nav-burger"><span
                    class="pz-nav__hamburger-box"><span class="pz-nav__hamburger-inner"></span></span></div><a
                class="pz-nav__title pz-h1" href="/crosswords"
                aria-label="New York Times Games Logo. Click for more puzzles"><svg class="pz-nav__logo" width="138"
                    height="25" viewBox="0 0 138 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="pz-nav__actions pz-flex-row"><a
                    href="https://www.nytimes.com/subscription/games?campaignId=4QHQ8"
                    class="pz-nav__button">Subscribe</a><a
                    href="https://myaccount.nytimes.com/auth/login?redirect_uri=https%3A%2F%2Fwww.nytimes.com%2Fpuzzles%2Fspelling-bee&amp;response_type=cookie&amp;client_id=games&amp;application=crosswords&amp;asset=navigation-bar"
                    class="pz-nav__button white">Log In</a></div>
        </div>
        <div class="pz-nav-drawer" id="js-nav-drawer">
            <nav>
                <h4 class="pz-nav-drawer__heading">New York Times Games</h4>
                <div class="pz-nav-drawer__group daily-crossword"><a href="/crosswords/game/daily"
                        class="pz-nav-drawer__link">The Crossword</a><a href="/puzzles/stats"
                        class="pz-nav-drawer__link">Statistics</a></div>
                <div class="pz-nav-drawer__group mini-crossword"><a href="/crosswords/game/mini"
                        class="pz-nav-drawer__link">The Mini</a><a href="/puzzles/leaderboards"
                        class="pz-nav-drawer__link">Leaderboards</a></div>
                <div class="pz-nav-drawer__group spelling-bee"><a href="/puzzles/spelling-bee"
                        class="pz-nav-drawer__link">Spelling Bee</a></div>
                <div class="pz-nav-drawer__group tiles"><a href="/puzzles/tiles" class="pz-nav-drawer__link">Tiles</a>
                </div>
                <div class="pz-nav-drawer__group letter-boxed"><a href="/puzzles/letter-boxed"
                        class="pz-nav-drawer__link">Letter Boxed</a></div>
                <div class="pz-nav-drawer__group vertex"><a href="/puzzles/vertex"
                        class="pz-nav-drawer__link">Vertex</a></div>
                <div class="pz-nav-drawer__group"><a href="/crosswords" class="pz-nav-drawer__link">All Games</a></div>
                <hr />
                <div class="pz-nav-drawer__group archive"><a href="/crosswords/archive"
                        class="pz-nav-drawer__link">Crossword Archives</a></div>
                <hr />
                <h4 class="pz-nav-drawer__heading">Other Games</h4>
                <div class="pz-nav-drawer__group kenken"><a href="/puzzles/kenken"
                        class="pz-nav-drawer__link">KenKen®</a></div>
                <div class="pz-nav-drawer__group sudoku"><a href="/puzzles/sudoku"
                        class="pz-nav-drawer__link">Sudoku</a></div>
                <div class="pz-nav-drawer__group set"><a href="/puzzles/set" class="pz-nav-drawer__link">Set®</a></div>
                <hr />
                <h4 class="pz-nav-drawer__heading">Tips and Tricks</h4>
                <div class="pz-nav-drawer__group tips-and-tricks"><a href="https://nytimes.com/column/wordplay"
                        class="pz-nav-drawer__link">Wordplay, the Crossword Column</a><a
                        href="https://nytimes.com/guides/crosswords/how-to-solve-a-crossword-puzzle"
                        class="pz-nav-drawer__link">How to Solve The Crossword</a></div>
            </nav>
            <div class="pz-nav-drawer__account">
                <div class="pz-nav-drawer__account-actions"><a
                        href="https://www.nytimes.com/subscription/games?campaignId=4QHQ8"
                        class="pz-nav__button">Subscribe</a><a
                        href="https://myaccount.nytimes.com/auth/login?redirect_uri=https%3A%2F%2Fwww.nytimes.com%2Fpuzzles%2Fspelling-bee&amp;response_type=cookie&amp;client_id=games&amp;application=crosswords&amp;asset=navigation-bar"
                        class="pz-nav__button white">Log In</a></div>
    ...
    <div class="pz-content">
        ...
        <div class="pz-section" id="spelling-bee-container">
            <div class="pz-row pz-game-title-bar">
                <div class="pz-module">
                    <h2><em class="pz-game-title">Spelling Bee</em><span class="pz-game-date">May 13, 2020</span></h2>
    ...
    <footer class="pz-footer">
        <div class="pz-footer__wrapper">
            <section class="pz-footer__section pz-footer__about-us">
                ...
                <p class="pz-footer__featured-text">Times games have captivated solvers since the launch of the
                    Crossword in 1941. Our experts create engaging word and visual games — in 2014 we introduced the
                    Mini Crossword, followed by Spelling Bee, Letter Boxed, Tiles and Vertex. We’ll continue to make new
                    games our players will be passionate about.</p>
                <p class="pz-footer__featured-text"><a
                        href="https://www.nytimes.com/subscription/games?campaignId=9W9LL">Subscribe now</a> for
                    unlimited access.</p>
            </section>
            <section class="pz-footer__section pz-footer__section-link-col">
                ...
                <ul class="pz-footer__list">
                    <li class="pz-footer__link"><a href="/crosswords/game/daily"><i
                                class="pz-icon pz-icon-daily"></i>The Crossword</a></li>
                    <li class="pz-footer__link"><a href="/crosswords/game/mini"><i class="pz-icon pz-icon-mini"></i>The
                            Mini Crossword</a></li>
                    <li class="pz-footer__link"><a href="/puzzles/spelling-bee"><i
                                class="pz-icon pz-icon-spelling-bee"></i>Spelling Bee</a></li>
                    <li class="pz-footer__link"><a href="/puzzles/tiles"><i class="pz-icon pz-icon-tiles"></i>Tiles</a>
                    </li>
                    <li class="pz-footer__link"><a href="/puzzles/letter-boxed"><i
                                class="pz-icon pz-icon-letter-boxed"></i>Letter Boxed</a></li>
                    <li class="pz-footer__link"><a href="/puzzles/vertex"><i
                                class="pz-icon pz-icon-vertex"></i>Vertex</a></li>
                    <li class="pz-footer__link"><a href="/crosswords">All Games</a></li>
                </ul>
            </section>
            <section class="pz-footer__section pz-footer__section-link-col">
                <h4 class="pz-footer__section-header">Other Games</h4>
                <ul class="pz-footer__list">
                    <li class="pz-footer__link"><a href="/puzzles/kenken">KenKen®</a></li>
                    <li class="pz-footer__link"><a href="/puzzles/sudoku">Sudoku</a></li>
                    <li class="pz-footer__link"><a href="/puzzles/set">Set®</a></li>
                </ul>
                <h4 class="pz-footer__section-header">Learn More</h4>
                <ul class="pz-footer__list">
                    <li class="pz-footer__link"><a
                            href="https://help.nytimes.com/hc/en-us/articles/115014755667-New-York-Times-Crossword">FAQs</a>
                    </li>
                    <li class="pz-footer__link"><a href="https://nytimes.com/subscription/crosswords/gift">Gift
                            Subscriptions</a></li>
                    <li class="pz-footer__link"><a href="mailto:NYTCrossword@nytimes.com" id="js-feedback-link"
                            target="__blank" rel="external">Contact Us</a></li>
                </ul>
            </section>
            <section class="pz-footer__section pz-footer__section-link-col">
                <h4 class="pz-footer__section-header">Crosswords</h4>
                <ul class="pz-footer__list">
                    <li class="pz-footer__link"><a href="/crosswords/archive">Crossword Archives</a></li>
                    <li class="pz-footer__link"><a href="/puzzles/stats">Statistics</a></li>
                    <li class="pz-footer__link"><a href="/puzzles/leaderboards">Leaderboards</a></li>
                    <li class="pz-footer__link"><a href="/crosswords/apps">Download the App</a></li>
                    <li class="pz-footer__link"><a href="/puzzles/submissions/crossword">Submit a Crossword</a></li>
                </ul>
                <h4 class="pz-footer__section-header">Community</h4>
                <ul class="pz-footer__list">
                    <li class="pz-footer__link"><a href="https://nytimes.com/column/wordplay">Wordplay,<br />the
                            Crossword Column</a></li>
                    <li class="pz-footer__link"><a href="https://twitter.com/NYTimesWordplay">Twitter</a></li>
                </ul>
            </section>
            <section class="pz-footer__section pz-footer__legal pz-footer__section-link-col">
                <ul class="pz-footer__legal-links">
                    <li class="pz-footer__legal-link"><a class="pz-footer__legal-co" href="https://www.nytco.com/">©
                            2020 The New York Times Company</a></li>
                    <li class="pz-footer__legal-link"><a href="https://nytimes.com">NYTimes.com</a></li>
                    <li class="pz-footer__legal-link"><a href="https://spiderbites.nytimes.com/">Sitemap</a></li>
                    <li class="pz-footer__legal-link"><a
                            href="https://nytimes.com/subscription/privacy-policy#/privacy">Privacy Policy</a></li>
                    <li class="pz-footer__legal-link"><a
